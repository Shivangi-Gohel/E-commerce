      ...
      <div className='md:flex justify-between mx-20'>
        <div className='flex flex-col gap-4 mb-10'>
          ...
          <div className='md:flex gap-5'>
            <Button className="text-white bg-amber-950 md:m-0 m-1 hover:bg-amber-950/90" onClick={() => navigate('/item')}>Shop Now <img src="https://images.icon-icons.com/1993/PNG/512/arrow_arrows_back_direction_left_navigation_right_icon_123236.png" className='h-5 w-5 invert'  alt="" /></Button>
